...
api_key = os.getenv("AIzaSyCt2PBKZz5AQ7fwecq1jq9k3_W0QJGQ_BY") or "AIzaSyCt2PBKZz5AQ7fwecq1jq9k3_W0QJGQ_BY"
...
def suggest_description(data: AISuggestionRequest, current_user: models.User = Depends(auth.get_current_user)):
    try:
        model = genai.GenerativeModel("gemini-1.5-flash")
        prompt = f"You are a helpful productivity assistant. Generate a concise, practical 1-sentence description for the task title: {data.title}"
